...
<body class="create-event-body">
    ...
    <h1 class="myevents-heading"><?php echo htmlspecialchars($event['event_name']); ?></h1>

    <main class="view-event-container">
        <div class="event-details">
            <p><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo htmlspecialchars($event['event_date']); ?></p>
            <p><i class="fa fa-list-ul" aria-hidden="true"></i> <?php echo htmlspecialchars($event['category_name']); ?></p>
            <p><i class="fa fa-tag" aria-hidden="true"></i> $<?php echo htmlspecialchars($event['ticket_price']); ?></p>
