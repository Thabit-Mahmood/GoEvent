        ...
        <div class="card mb-4 mb-xl-0">
          ...
          <div class="card-body text-center">
            <img class="img-account-profile rounded-circle mb-2"
              src="<?php echo htmlspecialchars($user['profile_picture'], ENT_QUOTES, 'UTF-8'); ?>" alt="Profile Picture">
              ...
              <div class="row gx-3 mb-3">
                <div class="input-wrapper mb-3">
                  <div class="input-group">
                    <input type="text" id="inputUsername" name="username" value="<?php echo htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8'); ?>" required>
                    <label class="input-placeholder" for="inputUsername">Username</label>
                  </div>
                </div>
                <div class="col-md-6 input-wrapper">
                  <div class="input-group">
                    <input type="email" id="inputEmailAddress" name="email" value="<?php echo htmlspecialchars($user['email'], ENT_QUOTES, 'UTF-8'); ?>" required>
