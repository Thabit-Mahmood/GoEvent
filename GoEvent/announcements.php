...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['announcement_text'])) {
    $announcement_text = htmlspecialchars($_POST['announcement_text'], ENT_QUOTES, 'UTF-8'); // Prevent XSS
    $announcement_id = isset($_POST['announcement_id']) ? intval($_POST['announcement_id']) : null;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_announcement_id'])) {
    $delete_announcement_id = intval($_POST['delete_announcement_id']);
