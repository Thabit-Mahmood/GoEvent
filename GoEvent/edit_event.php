...
<body class="create-event-body">
    ...
    <div class="create-event-container">
        ...
        <form action="edit_event.php?id=<?php echo $event_id; ?>" method="POST" enctype="multipart/form-data" class="register-container">
            ...
            <div class="input-wrapper">
                <div class="input-group">
                    <input type="text" id="event_description" name="event_description" value="<?php echo htmlspecialchars($event['event_description']); ?>" required>
                    <label class="input-placeholder" for="event_description">Event Description</label>
                </div>
            </div>
            <div class="input-wrapper">
                <div class="input-group">
                    <input type="number" id="ticket_price" name="ticket_price" value="<?php echo htmlspecialchars($event['ticket_price']); ?>" required>
                    <label class="input-placeholder" for="ticket_price">Ticket Price</label>
                </div>
            </div>
            <div class="input-wrapper">
                <div class="input-group">
                    <input type="datetime-local" id="event_date" name="event_date" value="<?php echo htmlspecialchars($event['event_date']); ?>" required>
                </div>
            </div>
            <div class="input-wrapper">
                <div class="input-group">
