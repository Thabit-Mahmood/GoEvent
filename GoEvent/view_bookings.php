...
// Prepare the statement to fetch bookings for the events organized by the logged-in organizer
                ...
                <table class="events-table">
                    ...
                    <tbody>
                        <?php foreach ($bookings as $booking): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($booking['event_name'], ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($booking['username'], ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($booking['email'], ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($booking['quantity'], ENT_QUOTES, 'UTF-8'); ?></td>
                                <td>RM<?php echo htmlspecialchars(number_format($booking['total_price'], 2), ENT_QUOTES, 'UTF-8'); ?></td>
