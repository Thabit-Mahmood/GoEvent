...
<head>
  ...
  <title>Shopping Cart - GoEvent</title>
  <link rel="stylesheet" href="css/style.css">
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&family=Google+Sans&display=swap"
    rel="stylesheet">
  ...
  <main class="cart-container">
    <div class="cart-content">
      ...
      <h1>
        ...
        <span class="cart-items-num">(
          <?php echo $total_items_in_cart;
        echo $total_items_in_cart == 1 ? " item" : " items";
        ?>)
        </span>
      </h1>
      <a href="home.php" class="continue-shopping-heading">Continue shopping</a>
      <div class="cart-wrapper">
        ...
        <h1>
          <span class="cart-title2">Your cart is empty</span>
        </h1>
